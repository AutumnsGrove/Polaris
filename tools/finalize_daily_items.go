				...
				"items": map[string]interface{}{
					...
					"items": map[string]interface{}{
						...
						"properties": map[string]interface{}{
							...
							"summary": map[string]interface{}{"type": "string", "description": "1-3 sentences on this story alone — never mention any other item."},
					...
					"description": "Every distinct story found, most significant first — never merge two stories into one item.",
				},
			},
